                  ...
                  <div class="col-12 text-center">
                    <div class="align-items-center justify-content-between">
                      <div class="align-items-center mb-4 mb-lg-0">
                        ...
                        <div class="ml-3">
                          <h4 class="mb-3">Head Shot Photograph</h4>
                        </div>
                      </div>
                      <div>
            ...
            <div>
                ...
                <form class="form-row">
                    ...
                    <div class="form-group col-12 col-md-6 text-center">
                      <div class="align-items-center mb-4 mb-lg-0">
                        <img src="../<?php echo $picture1;?>" 	id="img-uploaded" height="200" width="200" class="img-fluid mb-3 rounded-lg" alt="" />
                        <div class="ml-3">
                          <h4 class="mb-3">Barebody/Top less Photograph</h4>
                        </div>
                      </div>
                      <div>
                        <a href="#!" class="btn btn-primary btn-sm">View</a>
                    ...
                    <div class="form-group col-12 col-md-6 text-center">
                      <div class="align-items-center mb-4 mb-lg-0">
                        <img src="../<?php echo $picture2;?>" 	id="img-uploaded" height="200" width="200" class="img-fluid mb-3 rounded-lg" alt="" />
                        <div class="ml-3">
                          <h4 class="mb-3">Full Body Shot Photograph</h4>
                        </div>
                      </div>
                      <div>
                        <a href="#!" class="btn btn-primary btn-sm">View</a>
