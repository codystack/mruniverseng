...
<head>
    <title>Login :: Mr. Universe Nigeria&trade;</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body class="bg-light">
    ...
    <div class="d-flex align-items-center position-relative vh-100">
        ...
        <div class="col-lg-5 col-xl-4 d-none d-lg-flex border-top border-primary border-top-4 align-items-center vh-100 px-0" style="background-image: url(https://i.imgur.com/3AzQdLp.jpg); background-position:33% 30%;">
        </div>
        <div class="container">
