    <!-- navigation start -->
    <div class="header bg-dark border-top-3 border-top border-primary header-collapse">
        <div class="container-lg">
            <nav class="navbar navbar-expand-lg navbar-default">
                <a class="navbar-brand" href="\"><img src="assets/images/logo.png" alt="" width="170px" /></a>
