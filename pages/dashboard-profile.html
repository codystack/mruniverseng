...
<!-- Mirrored from codescandy.com/coach/pages/dashboard-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Dec 2020 21:22:17 GMT -->
<head>
    <title>Coach - Dashboard Profile Page</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="header position-sticky border-top-3 border-top border-primary bg-dark">
        ...
        <div class="container-lg">
            <nav class="navbar navbar-expand-lg navbar-default">
                <a class="navbar-brand" href="../index-2.html"><img src="../assets/images/logo.svg" alt="" /></a>
            ...
            <span class="icon-bar bottom-bar"></span>
              ...
              <i class="fas fa-times"></i>
                  ...
                  Homepages
                            ...
                            <ul class="dropdown-menu  dropdown-menu-arrow " aria-labelledby="menu-1">
                                ...
                                <li class="">
                                    <a class="dropdown-item" href="business-coach.html">


                                        <h4 class="mb-0 h5">Business Coach</h4>
                                        <p class="text-muted mb-0 font-12">
                                ...
                                <li class="">
                                    <a class="dropdown-item" href="life-coach.html">


                                        <h4 class="mb-0 h5">Life Coach</h4>
                                        <p class="text-muted mb-0 font-12">
                                ...
                                <li class="">
                                    <a class="dropdown-item" href="ceo-coach.html">


                                        <h4 class="mb-0 h5">CEO Coaching</h4>
                                        <p class="text-muted mb-0 font-12">
                                ...
                                <li class="dropdown-submenu ">
                                    <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#!">
                                        <div class="d-flex align-items-center">
                                            <div class="mr-3 icon-shape icon-lg rounded-circle bg-light">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-lg-right">
                                        <li>
                                            <a class="dropdown-item" href="program-grid.html">
                          Grid</a
                        >
                      </li>
                      <li>
                    ...
                    >
                      <div class="d-flex align-items-center">
                        ...
                        <div class="">
                          ...
                          <p class="text-muted mb-0 font-12">
                            Imporve Yourself to listen podcast.
                          </p>
                        </div>
                      </div>
                    </a>
                    ...
                    >
                      <div class="d-flex align-items-center">
                        <div
                          class="mr-3 icon-shape icon-lg rounded-circle bg-light"
                        >
                          <i class="flaticon-file font-24"></i>
                        </div>
                        <div class="">
                          <h4 class="mb-0 h5">Courses</h4>
                          <p class="text-muted mb-0 font-12">
                            Find the motivational courses
                          </p>
                        </div>
                      </div>
                    </a>
                                                            <ul class="dropdown-menu dropdown-menu-lg-right">
                                                                <li>
                                                                    <a class="dropdown-item" href="course-thumbnail.html">
                          Grid</a
                        >
                      </li>
                      <li>
                  ...
                  <li class="dropdown-submenu">
                    ...
                    >
                      ...
                      Pricing <span class="text-primary ml-1 font-12">(New)</span></a
                    >
                  </li>
                                                                        <li>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  Blog
                      ...
                      Blog Category
                                                                                ...
                                                                                <li>
                                                                                    <a class="dropdown-item" href="blog-classic.html">
                      Blog Classic
                    </a>
                                                                                </li>
                                                                                <li>
                 ...
                 Resources
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-arrow dropdown-menu-right dropdown-menu-xl-left " aria-labelledby="menu-4">

                                                                                <li class="dropdown-submenu">
                                                                                    <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#!">


                                                                                        <h4 class="mb-0 h5">Help Center <span class="text-primary font-12 ml-1">(New)</span></h4>
                                                                                        <p class="text-muted mb-0 font-12">
                                                                                            How can we help?
                                                                                        </p>
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-lg-right">
                                                                                        ...
                                                                                        <li class="dropdown-submenu">
                                                                                            <a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                                                <h4 class="mb-0 h5">Webinar<span class="text-primary font-12 ml-1">(New)</span></h4>
                                                                                                <span class="text-muted mb-0 font-12">
                         Webinar Landing Page Design
                        </span>
                                                                                            </a>
                                                                                            <ul class="dropdown-menu dropdown-menu-lg-right">
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="coach-webinar.html">
                                                                                         Webinar List </a
                                                                                        >
                                                                                      </li>
                                                                                      <li>
                                                                                        <a class="dropdown-item" href="coach-webinar-single.html">
                                                                             Webinar Single </a
                                                                            >
                                                                          </li>
                                                                                      <li>
                                                                                        <a class="dropdown-item" href="coach-webinar-booking.html">
                                                                            Webinar Booking </a
                                                                            >
                                                                          </li>
                                                                                        ...
                                                                                        <li class="">
                                                                                            <a class="dropdown-item" href="book-download-page.html">

                                                                                                <h4 class="mb-0 h5">Download Book</h4>
                                                                                                <span class="text-muted mb-0 font-12">
                          Download the book that guide your life lession.
                        </span>
                                                                                                ...
                                                                                                <li class="">
                                                                                                    <a class="dropdown-item" href="stories.html">
                                                                                                        ...
                                                                                                        <div class="">
                                                                                                            <h4 class="mb-0 h5">Success Stories</h4>
                                                                                                            <p class="text-muted mb-0 font-12">
                                                                                                                See what our clients say & success stories.
                                                                                                            </p>
                                                                                                        </div>
                                                                                                ...
                                                                                                <li class="">
                                                                                                    <a class="dropdown-item" href="booking-page.html">

                                                                                                        <div class="">
                                                                                                            <h4 class="mb-0 h5">Free Session Booking</h4>
                                                                                                            <p class="text-muted mb-0 font-12">
               ...
               Account
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-arrow dropdown-menu-right dropdown-menu-xl-left " aria-labelledby="menu-5">
                                                                                                <li class="dropdown-submenu ">
                                                                                                    <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#!">
                                                                                      Sign In
                                                                                    </a>
                                                                                            ...
                                                                                            Side Cover <span class="text-primary font-12 ml-1">(New)</span></a
                                                                                          >
                                                                                        </li>
                                                                                        <li>
                                                                                    ...
                                                                                    <li class="dropdown-submenu ">
                                                                                      ...
                                                                                      <li>
                                                                                        <a class="dropdown-item" href="verify-code.html">
                                                                                          Verify Code <span class="text-primary font-12 ml-1">(New)</span>
                                                                                        </a>
                                                                                                                </li>
                                                                                                                <li class="dropdown-submenu ">
                                                                                                                    <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#!">
                                                                                        ...
                                                                                        <li class="dropdown-submenu ">
                                                                                          <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#!">
                                                                                           Setting <span class="text-primary font-12 ml-1">(New)</span>
                                                                                          </a>
                                                                                                                            <ul class="dropdown-menu dropdown-menu-lg-right">
                                                                                                                                <li>
                                                                                              ...
                                                                                              <li>
                                                                                                <a class="dropdown-item" href="dashboard-subscription.html">
                                                                                                  Subscription</a
                                                                                                >
                                                                                              </li>
                                                                                              <li>
                                                                                                <a class="dropdown-item" href="dashboard-security.html">
                                                                                                  Security</a
                                                                                                >
                                                                                              </li>
                                                                                              <li>
                                                                                                <a class="dropdown-item" href="dashboard-notifications.html">
                                                                                                  Notifications</a
                                                                                                >
                                                                                              </li>
                                                                                              <li>
                                                                                                <a class="dropdown-item" href="dashboard-user.html">
                                                                                                  Users</a
                                                                                                >
                                                                                              </li>
                                                                                              <li>
                                                                                                <a class="dropdown-item" href="dashboard-payment-plan.html">
                                                                                                  Payment Plan</a
                                                                                                >
                                                                                              </li>
                                                                                              <li>
                                                                                                <a class="dropdown-item" href="dashboard-payment-history.html">
                                                                                                  Payment History</a
                                                                                                >
                                                                                              </li>
                                                                              ...
                                                                              <li class="nav-item dropdown">
                                                                                ...
                                                                                >
                                                                                  Shop
                                                                                                                                    ...
                                                                                                                                    <ul class="dropdown-menu dropdown-menu-arrow dropdown-menu-right dropdown-menu-xl-left " aria-labelledby="menu-6">
                                                                                                                                        <li>
                                                                                     ...
                                                                                     Product Single
                                                                                      ...
                                                                                      Checkout
                                                                                                                                        ...
                                                                                                                                        <li>
                                                                                                                                            <a class="dropdown-item" href="shop-empty-cart.html">
                                                                                     Empty Cart
                                                                                    </a>
                                                                                                                                        </li>
                                                                                                                                        <li>
                                                                                                                                            <a class="dropdown-item" href="shop-order-completed.html">
                                                                                  Order Completed
                                                                                  </a>
                                                                                                                                        </li>
                                                                                                                                    </ul>
                                                                                                                                ...
                                                                                                                                <li class="nav-item dropdown">
                                                                                                                                   ...
                                                                                                                                   Docs
                                                                                                                                    ...
                                                                                                                                    <ul class="dropdown-menu dropdown-menu-arrow dropdown-menu-right dropdown-menu-xl-left  " aria-labelledby="menu-7">
                                                                                                                                        <li>
                                                                                                                                            <a class="dropdown-item" href="../docs/index.html">
                                                                                                                                                <div class="d-flex align-items-center">
                                                                                                                                                    <span class="mr-3">
                                                                                                                                                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                    <path d="M4 19.5C4 18.837 4.26339 18.2011 4.73223 17.7322C5.20107 17.2634 5.83696 17 6.5 17H20" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    <path d="M6.5 2H20V22H6.5C5.83696 22 5.20107 21.7366 4.73223 21.2678C4.26339 20.7989 4 20.163 4 19.5V4.5C4 3.83696 4.26339 3.20107 4.73223 2.73223C5.20107 2.26339 5.83696 2 6.5 2V2Z" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    </svg>
                                                                                                                                        ...
                                                                                                                                        <li>
                                                                                                                                            <a class="dropdown-item" href="../docs/snippet-overview.html">
                                                                                                                                                <div class="d-flex align-items-center">
                                                                                                                                                    <span class="mr-3"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                    <path d="M21 15.9999V7.9999C20.9996 7.64918 20.9071 7.30471 20.7315 7.00106C20.556 6.69742 20.3037 6.44526 20 6.2699L13 2.2699C12.696 2.09437 12.3511 2.00195 12 2.00195C11.6489 2.00195 11.304 2.09437 11 2.2699L4 6.2699C3.69626 6.44526 3.44398 6.69742 3.26846 7.00106C3.09294 7.30471 3.00036 7.64918 3 7.9999V15.9999C3.00036 16.3506 3.09294 16.6951 3.26846 16.9987C3.44398 17.3024 3.69626 17.5545 4 17.7299L11 21.7299C11.304 21.9054 11.6489 21.9979 12 21.9979C12.3511 21.9979 12.696 21.9054 13 21.7299L20 17.7299C20.3037 17.5545 20.556 17.3024 20.7315 16.9987C20.9071 16.6951 20.9996 16.3506 21 15.9999Z" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    <path d="M3.27002 6.95996L12 12.01L20.73 6.95996" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    <path d="M12 22.08V12" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    </svg>
                                                                                                                                                    </span>
                                                                                                                                                    <div>
                                                                                                                                        ...
                                                                                                                                        <li>
                                                                                                                                            <a class="dropdown-item" href="../docs/changelog.html">
                                                                                                                                                <div class="d-flex align-items-center">
                                                                                                                                                    <span class="mr-3">  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                    <path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    <path d="M14 2V8H20" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    <path d="M16 13H8" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    <path d="M16 17H8" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    <path d="M10 9H9H8" stroke="#bbb9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                                                                                    </svg>
                                                                                                                                                    </span>
                                                                                                                                                    <div>
                                                                                                                                                        <h5 class=" mb-0 ">Changelog <span class="text-primary font-12 ml-1 ">1.1.1</span></h5>
								...
								<div class="navbar-nav flex-column w-100 ">
									...
									<div class="p-4">
										...
										<ul class="list-unstyled mb-4 mt-2">
											...
											<li class="nav-item ">
												<a class="nav-link" href="dashboard-subscription.html"
													>Subscriptions</a
												>
											</li>
											<li class="nav-item ">
												<a class="nav-link" href="dashboard-security.html"
													>Security</a
												>
											</li>
											<li class="nav-item ">
												<a class="nav-link" href="dashboard-notifications.html"
													>Notifications</a
												>
											</li>
											<li class="nav-item ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="dashboard-payment-plan.html">Plan & Payment</a
											...
											<li class="nav-item">
												<a
													class="nav-link"
													href="dashboard-payment-history.html"
													>Payment History</a
												>
											</li>
										</ul>
					...
					<div class="col-lg-9 col-md-8 col-12">
						<div class="card rounded-lg mb-4 ">
							...
							<div class="card-header bg-white p-4">
								<h3 class="mb-0 h4">My Profile</h3>
							</div>
							<!-- card body -->
                ...
                <form class="form-row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        <label class="font-14 text-dark" for="fname">First Name<span class="text-danger">*</span></label
										...
										<div class="form-group col-12 col-md-6">
											<label class="font-14 text-dark" for="lname"
										...
										<div class="form-group col-12 col-md-6">
											<label class="font-14 text-dark" for="email"
                    ...
                    <div class="form-group col-12 col-md-12">
                        <label class="font-14 text-dark" for="address">Address Line 1</label
										...
										<div class="form-group col-12 col-md-12">
											<label class="font-14 text-dark" for="address2"
    ...
    <div class="card rounded-lg mb-4 ">
        <!-- card header -->
        <div class="card-header bg-white p-4">
            <h3 class="mb-0 h4">Privacy Settings</h3>
        </div>
        <!-- card body -->
        <div class="card-body p-4">
            <div class="d-md-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                <div class="">
                    <h4 class="mb-1 h5">Public Profile</h4>
                    <p class="mb-0 font-14">
                        Making your profile publo means anyone can see your information.
                    </p>
                </div>
                <div class="">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="publicProfile" checked />
                        <label class="custom-control-label" for="publicProfile"></label>
                    </div>
                </div>
            </div>
            <div class="d-md-flex justify-content-between align-items-center ">
                <div class="">
                    <h4 class="mb-1 h5">Expose your email.</h4>
                    <p class="mb-0 font-14">
                        This lets user find you by your email address.
                    </p>
                </div>
                <div class="">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="privacySetting" />
                        <label class="custom-control-label" for="privacySetting"></label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card rounded-lg ">
        <div class="card-body p-4">
            <p class="mb-0">
                <i class="fe fe-trash-2 font-20  mr-2 text-primary"></i>If you no longer want to use Coach, you can
                <a href="#!">delete our account.</a>
            </p>
        </div>
    </div>
    </div>
