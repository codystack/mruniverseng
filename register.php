...
if (isset($_POST['register_btn'])) {
    ...
    if (preg_match("!image!", $_FILES['picture']['type'])) {
        ...
        if (copy($_FILES['picture']['tmp_name'], $picture_path)) {
            ...
            }else { $sql = "INSERT INTO users (fname, lname, email, phone, state, age, ighandle, picture, regno)"
                    . "VALUES ('$fname', '$lname', '$email', '$phone', '$state', '$age', '$ighandle', '$picture_path', '$regno')";
                    if($query){
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class='text-center pdb-2-5x'>
                                                        <center>
                                                        <a href='https://voteonline.com.ng' target='_blank'><img class='email-logo' src='https://i.imgur.com/cwSjIc8.png' /></a>
                                                        </center>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class='pdl-3x pdr-3x pdb-2x'>
                                                        ...
                                                        <p class='mgb-1x'>
                                                            Welcome! <br />
                                                            You are receiving this email because you have registered on Mr. Universe Nigeria.
                                                        </p>
                                                        <p class='mgb-1x'>Copy the Reg No. below and keep safe.</p>
                                                ...
                                                <tr>
                                                    <td class='pd-3x pdt-2x pdb-3x'>
                                                        ...
                                                        <p class='email-note'>This is an automatically generated email please do not reply to this email. If you face any issues, please contact us at help@mruniversenigeria.org</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class='pd-3x pdt-2x pdb-3x'>
